...
<section id="seccion-contacto" className="nuevos border-bottom border-secondary border-2">
  ...
  <div className="nuevos-contacto container  border-top border-primary" id="contenedor-formulario">
      ...
      <form   method="POST" data-netlify="true" action="#">     
          ...
          <div className="mb-3">
            <button type="submit" className=" btn btn-primary w-100 fs-5">Enviar Mensaje</button>
          </div>
      </form>
